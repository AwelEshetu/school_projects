...
// get_event is a joint view of the tables 'dates','events' and 'geolocation'
$query = "SELECT * FROM get_event WHERE group_id=1"; 
...
// If the tags do not have any information they will display only a single tag: <example /> - The database should thus to have default values set for everything to make sure the parser understands the string.

//Sections from different tables in this loop have been separated by comments for your convenience. How awesome is that!?
