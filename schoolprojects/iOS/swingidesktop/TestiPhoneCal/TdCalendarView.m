...
-(void)drawTopBarWords{
	...
	NSString *title_Month   = [[NSString alloc] initWithFormat:@"%d Year %d Month",currentMonthDate.year,currentMonthDate.month];
	
	int fontsize=[UIFont buttonFontSize];
    UIFont   *font    = [UIFont systemFontOfSize:titleFontSize];
	CGPoint  location = CGPointMake(width/3 -2.4*titleFontSize, 0);
	...
	[@"Mon" drawAtPoint:CGPointMake(s_width*0+9,fontsize) withFont:weekfont];
	[@"Tue" drawAtPoint:CGPointMake(s_width*1+9,fontsize) withFont:weekfont];
	[@"Wed" drawAtPoint:CGPointMake(s_width*2+9,fontsize) withFont:weekfont];
	[@"Thu" drawAtPoint:CGPointMake(s_width*3+9,fontsize) withFont:weekfont];
	[@"Fri" drawAtPoint:CGPointMake(s_width*4+9,fontsize) withFont:weekfont];
	[[UIColor redColor] set];
	[@"Sat" drawAtPoint:CGPointMake(s_width*5+9,fontsize) withFont:weekfont];
	[@"Sun" drawAtPoint:CGPointMake(s_width*6+9,fontsize) withFont:weekfont];
	[[UIColor blackColor] set];
