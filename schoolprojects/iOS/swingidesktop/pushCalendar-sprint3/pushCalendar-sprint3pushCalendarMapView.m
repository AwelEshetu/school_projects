...
- (NSString *)subtitle{
	return @"Subtitle goes here yyyeeeeeeeeaahaaawwww";
...
- (IBAction) showAddress {
	...
	addAnnotation = [[AddressAnnotation alloc] initWithCoordinate:doit];
    ...
    //Creates the annotation
	endAnnotation = [[AddressAnnotation alloc] initWithCoordinate:doit];
